          ...
          <>
            <div className="contTable">
              ...
              <div className="secondrow">
                ...
                <button className="linksbtn">Assign to Profile</button>
                <button className="linksbtn ">Assign to Group</button>
                <button className="links">
                  <GoListUnordered />
                </button>
              ...
              <table className="table" style={{ boderColor: "lightgray" }}>
                <tbody>
                  <tr
                    className="theader"
                    style={{ backgroundColor: "rgba(249,250,252,255)" }}
                  >
                    <td>
                  ...
                  {value.usersData &&
                    value.usersData.map((user, index) => {
                      return (
                        <>
                          <tr
                            className="trow"
